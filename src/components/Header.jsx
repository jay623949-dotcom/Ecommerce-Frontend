      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="h-20 flex items-center justify-between gap-10">
          ...
          <div className="flex items-center gap-7">
            ...
            <button className="font-medium text-slate-700 hover:text-blue-600 transition">
              Login
            </button>

            <button className="px-5 py-2.5 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 transition shadow">
              Register
            </button>
